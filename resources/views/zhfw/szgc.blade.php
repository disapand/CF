...
@section('contents')
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <img src=" {{ asset('images/zhfw/szgc_dt.jpg') }}" alt="" style="width: 100%;">
        </div>
    </div>
    ...
    <div class="row" style="line-height: 2em;margin-bottom: 50px;">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-md-offset-3">
            <p style="text-indent: 2em;text-align: justify;">为服务泾河新城的发展规划，加快完善泾河新城现代城市服务体系，城服公司拟开展泾河新城市政环境工程。市政工程通过市场化运作模式全面实施泾河新城内市政养护、绿化养护业务。一方面，市政工程通过承接泾河新城内市政、绿化业务可获取良好的经营收益; 另一方面，通过拓展业务类型，将城市综合服务落到实处，提升城市管理水平，实现良好的社会效益。</p>
        </div>
    </div>

...
@section('contents')
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <p style="text-align: justify;text-indent: 2em;margin-top: 20px;line-height: 2.5em;">
                        泾河新城作为现代化大西安新中心文化旅游新高地，区域内建设了多个文化旅游项目，如乐华城、茯茶镇、崇文塔景区、泾河智慧农业园、寿平民宿小镇、崇文湖风景区、丝路盛典大型实景演出等。其中崇文塔景区依托着高87.218m的中国第一高砖塔——崇文塔，建成陕商、秦腔、非遗、国学四个文化博览馆，是区域内重点文化旅游项目，致力于文化保护、文化传播、文化交流活动，营造全新的文化氛围，促进新城精神文明建设，加强交流，打造大西安北部新中心文化旅游高地。</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-md-offset-2"
             style="background-color: #eeeeee;padding-top: 20px;padding-bottom: 20px;margin-bottom: 60px;">
            <div class="row">

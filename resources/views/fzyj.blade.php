...
@section('contents')
    ...
    <div class="row">
        <div class="col-xs-10 col-sm-10 col-md-8 col-lg-8 col-md-offset-2 wzys col-sm-offset-1 col-xs-offset-1">
            ...
            <p style="margin-top: 10px; margin-bottom: 30px;">“科技创新服务、专业成就精品”作为企业的核心精神，是我们一直以来追求的最高目标。我们将争取在五年内成为西成新区首屈一指的品牌运营服务管理企业，并在智慧城市、云数据管理等方面有所突破，将服务项目打造成为智能化、信息化的代表。</p>

...
@section('contents')
    ...
    <div class="row">
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2">
            <img src="{{ asset('images/wyjl/gafj_z.png') }}" alt="" class="center-block" style="margin-top: 100px;">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 wzys">
            <p style="margin-top: 50px;margin-bottom: 50px;">该项目位于泾河新城崇文佳苑三区西北角，办公区域分为2层，面积约为1300平米，项目配备项目经理一名，主管一名，保安8名，保洁6名。日常服务包含24小时监控安保服务、办公室及公共区域内部精细化保洁、户外道路清扫工作。项目管理人员经过专业培训，具有多年物业服务管理工作经验；在人员配置上借鉴成熟物业服务项目的成功经验，按照精干高效的原则，合理配备项目所需人员，为泾河新城公安分局保一方平安提供优质服务。</p>
        </div>
    </div>

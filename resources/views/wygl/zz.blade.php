...
@section('contents')
    ...
    <div class="row">
        <div class="col-xs-10 col-sm-10 col-md-8 col-lg-8 col-md-offset-2 wzys col-xs-offset-1 col-sm-offset-1">
            <p style="margin-top: 50px;margin-bottom: 25px;">崇文佳苑坐落于西咸新区泾河新城崇文镇二路，占地约为600余亩，建筑面积58.2万㎡，总共可容纳12000余户居民。目前主要分为四大区域，崇文佳苑一区（已居住人口大约52％）、二区（在建）、三区（已居住人口大约36％）、八区（楼宇已建成，正在建造围墙），该项目属于公租房、廉租房及周边区域居民回迁安置房集一体的大型社区，周边有完善的商业配套设施，商场、中学、小学幼、儿园。</p>

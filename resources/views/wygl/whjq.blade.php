...
@section('contents')
    ...
    <div class="row">
        <div class="col-xs-10 col-sm-10 col-md-8 col-lg-8 col-md-offset-2 wzys col-xs-offset-1 col-sm-offset-1">
            <p style="margin-top: 50px;margin-bottom: 25px;">崇文塔景区位于西咸新区泾河新城崇文文化旅游景区板块，交通便利，东临正阳大道，西接包茂复线，南邻泾河，北接泾河大道。总占地面积约394亩，分为三期开发建设。</p>
    ...
    <div class="row">
        <div class="col-xs-10 col-sm-10 col-md-8 col-lg-8 col-md-offset-2 wzys col-xs-offset-1 col-sm-offset-1">
            ...
            <p style="margin-top: 25px;margin-bottom: 50px;">服务范围：茯茶文化博物馆的公用部分的设施设备的维修、养护和管理。公共环境的卫生清理、垃圾收集及清运、交通、车辆行驶、停泊管理、茯茶文化博物馆的安全监控和巡视工作、消防管理、其他特约服务。</p>
        </div>
    </div>

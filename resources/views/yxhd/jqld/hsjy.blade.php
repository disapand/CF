...
@section('contents')
    ...
    <div class="row">
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2">
            <img src="{{ asset('images/yxhd/jqld/hsjy_dyz.png') }}" alt=""
                 style="margin-bottom: 30px;" class="center-block">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2">
            <img src="{{ asset('images/yxhd/jqld/hsjy_dez.png') }}" alt=""
    ...
    <div class="row" style="margin-bottom: 80px;">
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="{{ asset('images/yxhd/jqld/hsjy_dt2.jpg') }}" alt="" class="img-100">
                    </div>
                    <div class="swiper-slide">
                        <img src="{{ asset('images/yxhd/jqld/hsjy_dt2.jpg') }}" alt="" class="img-100">
                    </div>
    ...
    <div class="row">
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2">
            <img src="{{ asset('images/yxhd/jqld/hsjy_dsz.png') }}" alt=""
                 style="margin-bottom: 50px;" class="center-block">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 wzys" style="margin-bottom: 30px;">
            <p>
                安吴青训班旧址是第七批全国重点文物保护单位，陕西省重点文物保护单位。位于咸阳城北45公里处泾阳县安吴镇安吴堡村。是在中共中央青年工作委员会领导下，以西北青年救国联合会的名义，在当时的国民党统治区陕西省泾阳县安吴堡举办的培训青年干部的重要场所。它是抗日青年的旗帜、革命青年的熔炉、中国青运史上的丰碑。
            </p>
        </div>
    </div>
    ...
    <div class="row" style="margin-bottom: 150px;">
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="{{ asset('images/yxhd/jqld/hsjy_dt3.jpg') }}" alt="" class="img-100">
                    </div>
                    <div class="swiper-slide">
                        <img src="{{ asset('images/yxhd/jqld/hsjy_dt3.jpg') }}" alt="" class="img-100">
                    </div>

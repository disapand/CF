...
@section('contents')
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <img src="{{ asset('images/yxhd/yxhd_dt.jpg') }}" alt="" style="width: 100%;">
        </div>
    </div>

    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-md-offset-3" style="margin-top: 150px;margin-bottom: 50px;">
            <img src=" {{ asset('images/yxhd/yxhd_z.png') }}" alt="" style="width: 99%;">
        </div>
    </div>

    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-md-offset-3" style="margin-bottom: 50px;">
            <p style="text-indent: 2em;text-align: justify">泾河新城研学旅行充分挖掘区内旅游资源，形成文化＋教育、文化＋体验、文化＋农业、文化＋民俗等多种综合研学旅游产品，满足各阶段学生的研学需求，已经吸引了数百家学校前来研学，数家学校更是多次组织不同阶段的学生前来。现阶段研学旅行如火如荼，为了更加完善后续接待，崇文塔景区从研学教师、研学课程、研学基地、研学线路、安全管理等几个方面积极研究深化，将这种继承了中国传统儒家教育游学模式的“旅行”在泾河新城的发展日趋成熟化，让学生们体验到更丰富的学习方式。</p>
        </div>
    </div>
